...
#### 1. 数据分析、文件处理、计算器
<video width="100%" controls="controls" src="https://pydaxing-public.oss-cn-hangzhou.aliyuncs.com/20240625_Code_Interpreter/data_analysis_file_calculate.mp4"></video>

#### 2. 机器学习模型预测、相关性分析
<video width="100%" controls="controls" src="https://pydaxing-public.oss-cn-hangzhou.aliyuncs.com/20240625_Code_Interpreter/machine_learning.mp4"></video>

#### 3. 二维码生成
<video width="100%" controls="controls" src="https://pydaxing-public.oss-cn-hangzhou.aliyuncs.com/20240625_Code_Interpreter/er_wei_ma.mp4"></video>

#### 4. 词云图生成
<video width="100%" controls="controls" src="https://pydaxing-public.oss-cn-hangzhou.aliyuncs.com/20240625_Code_Interpreter/ci_cloud.mp4"></video>
